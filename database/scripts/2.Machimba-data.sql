...
('Susy', 'Elegante bolso en piel burdeos que combina sofisticación y carácter atemporal.', 'Permanente', 90, 'https://i.ibb.co/nDmHSGS/piel-burdeos.png', 'Burdeos', 'Piel'),
('Susy', 'Bolso en piel multicolor que fusiona tonos para crear un accesorio único.', 'Permanente', 90, 'https://i.ibb.co/ZJht2QX/metalizado-fantasia.png', 'Combinado', 'Piel'),
('Susy', 'Clásico bolso en piel tabaco que destaca por su elegancia intemporal.', 'Permanente', 90, 'https://i.ibb.co/tKZ7zwX/piel-tabaco.png', 'Tabaco', 'Piel'),
('Susy', 'Sofisticado bolso en piel negra, un clásico que nunca pasa de moda.', 'Permanente', 90, 'https://i.ibb.co/n74RpWL/piel-negra.png', 'Negro', 'Piel'),
('Susy', 'Delicado diseño en terciopelo rosa que irradia dulzura y feminidad.', 'Permanente', 90, 'https://i.ibb.co/zZKTGL6/rosa-perla.png', 'Rosa', 'Terciopelo'),
('Susy', 'Cautivador bolso en terciopelo verde que aporta un toque de distinción natural.', 'Permanente', 90, 'https://i.ibb.co/CM7RTN6/verde-billar.png', 'Verde', 'Terciopelo'),
('Susy', 'Sofisticado diseño en terciopelo azul que transmite serenidad y elegancia.', 'Permanente', 90, 'https://i.ibb.co/d4V1sHy/azul-elegante.png', 'Azul', 'Terciopelo'),
('Susy', 'Versátil bolso en terciopelo beige que destaca por su refinada neutralidad.', 'Permanente', 90, 'https://i.ibb.co/pryvHcF/beige.png', 'Beige', 'Terciopelo'),
('Susy', 'Elegante pieza en terciopelo verde que evoca la frescura con estilo.', 'Permanente', 90, 'https://i.ibb.co/MspRNPJ/musgo.png', 'Verde', 'Terciopelo'),
('Susy', 'Vibrante bolso en terciopelo mostaza que aporta calidez y personalidad.', 'Permanente', 90, 'https://i.ibb.co/FD25JP7/mostaza.png', 'Mostaza', 'Terciopelo'),
('Susy', 'Romántico diseño en terciopelo lila que irradia delicadeza y misterio.', 'Permanente', 90, 'https://i.ibb.co/nCVTBkk/lila.png', 'Lila', 'Terciopelo'),
('Susy', 'Majestuoso bolso en terciopelo morado que transmite realeza y distinción.', 'Permanente', 90, 'https://i.ibb.co/NKTNxtP/morado.png', 'Morado', 'Terciopelo'),
('Susy', 'Eterno diseño en terciopelo negro que encarna la elegancia absoluta.', 'Permanente', 90, 'https://i.ibb.co/CtH7RpP/terciopelo-negro.png', 'Negro', 'Terciopelo'),
...
('Machimbag', 'Clásico bolso en terciopelo verde con asas de piel negra, un diseño original que marcó el estilo de la marca.', 'Permanente', 90, '"https://i.ibb.co/KrK1BC5/verde-rayado.png”', 'Verde', 'Terciopelo'),
('Machimbag', 'Emblemático diseño en terciopelo verde realzado por sus asas de piel negra, símbolo del legado de la marca.', 'Permanente', 90, '"https://i.ibb.co/N9WPMMh/verde-pistacho.png”', 'Verde', 'Terciopelo'),
('Machimbag', 'Distinguido bolso en terciopelo mostaza con asas de piel negra, que evoca la esencia vintage de la colección.', 'Permanente', 90, '"https://i.ibb.co/vxkd2rF/mostaza-y-verde.png”', 'Mostaza', 'Terciopelo'),
('Machimbag', 'Icónico bolso en terciopelo rojo contrastado con asas de piel negra, un clásico atemporal.', 'Permanente', 90, '"https://i.ibb.co/c6TfSfZ/rojo.png”', 'Rojo', 'Terciopelo'),
('Machimbag', 'Eterno diseño en terciopelo verde complementado con asas de piel negra, parte de la historia de la marca.', 'Permanente', 90, '"https://i.ibb.co/Dfr3dQh/verde-musgo.png”', 'Verde', 'Terciopelo'),
('Machimbag', 'Sofisticado bolso en terciopelo mostaza con asas de piel negra, que mantiene viva la tradición.', 'Permanente', 90, '"https://i.ibb.co/tJvJXkX/mostaza-y-marron.png”', 'Mostaza', 'Terciopelo'),
('Machimbag', 'Legendario diseño en terciopelo verde y asas de piel negra, un tributo al origen de la marca.', 'Permanente', 90, '"https://i.ibb.co/1ZL46Bk/verde-botella.png”', 'Verde', 'Terciopelo'),
('Machimbag', 'Elegante bolso en terciopelo azul con asas de piel negra, que representa la herencia de la marca.', 'Permanente', 90, '"https://i.ibb.co/CnjJXWf/azul-celeste.png”', 'Azul', 'Terciopelo'),
('Machimbag', 'Distinguido diseño en terciopelo tabaco con asas de piel negra, un testamento al estilo original.', 'Permanente', 90, '"https://i.ibb.co/BnRpqpn/tabaco.png”', 'Tabaco', 'Terciopelo'),
('Machimbag', 'Majestuoso bolso en terciopelo morado realzado por asas de piel negra, un clásico reinventado.', 'Permanente', 90, '"https://i.ibb.co/cDVbbb9/morado.png”', 'Morado', 'Terciopelo'),
('Machimbag', 'Emblemático diseño en terciopelo azul con asas de piel negra, que mantiene vivo el espíritu original.', 'Permanente', 90, '"https://i.ibb.co/YkGqbSh/azul-otro-forro.png”', 'Azul', 'Terciopelo');
